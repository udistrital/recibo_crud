...
// @Param	body		body 	models.TipoRecibo	true		"body for TipoRecibo content"
// @Success 201 {int} models.TipoRecibo
// @Failure 403 body is empty
// @router / [post]
func (c *TipoReciboController) Post() {
	var v models.TipoRecibo
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoRecibo(&v); err == nil {
...
// @Success 200 {object} models.TipoRecibo
// @Failure 403 :id is empty
// @router /:id [get]
func (c *TipoReciboController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoReciboById(id)
	if err != nil {
		c.Data["json"] = models.Alert{Type: "error", Code: "E_400", Body: err.Error()}
	} else {
		c.Data["json"] = v
...
func (c *TipoReciboController) GetAll() {
	...
	l, err := models.GetAllTipoRecibo(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = models.Alert{Type: "error", Code: "E_400", Body: err.Error()}
	} else {
		c.Data["json"] = l
...
func (c *TipoReciboController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoRecibo{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTipoReciboById(&v); err == nil {
...
func (c *TipoReciboController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoRecibo(id); err == nil {
