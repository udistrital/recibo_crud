...
// a ver si sube esta genialidad 3
...
// @Param	body		body 	models.EstadoRecibo	true		"body for EstadoRecibo content"
// @Success 201 {int} models.EstadoRecibo
// @Failure 403 body is empty
// @router / [post]
func (c *EstadoReciboController) Post() {
	var v models.EstadoRecibo
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddEstadoRecibo(&v); err == nil {
...
// @Success 200 {object} models.EstadoRecibo
// @Failure 403 :id is empty
// @router /:id [get]
func (c *EstadoReciboController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetEstadoReciboById(id)
	if err != nil {
		c.Data["json"] = models.Alert{Type: "error", Code: "E_400", Body: err.Error()}
	} else {
		c.Data["json"] = v
...
func (c *EstadoReciboController) GetAll() {
	...
	l, err := models.GetAllEstadoRecibo(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = models.Alert{Type: "error", Code: "E_400", Body: err.Error()}
	} else {
		c.Data["json"] = l
...
func (c *EstadoReciboController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.EstadoRecibo{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateEstadoReciboById(&v); err == nil {
...
func (c *EstadoReciboController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteEstadoRecibo(id); err == nil {
