...
-- Permisos de usuario
GRANT USAGE ON SCHEMA recibo TO desarrollooas;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA recibo TO desarrollooas;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA recibo TO desarrollooas;
