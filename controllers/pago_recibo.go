...
// @Param	body		body 	models.PagoRecibo	true		"body for PagoRecibo content"
// @Success 201 {int} models.PagoRecibo
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *PagoReciboController) Post() {
	var v models.PagoRecibo
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddPagoRecibo(&v); err == nil {
...
// @Success 200 {object} models.PagoRecibo
// @Failure 404 not found resource
// @router /:id [get]
func (c *PagoReciboController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetPagoReciboById(id)
	if err != nil {
		logs.Error(err)
...
func (c *PagoReciboController) GetAll() {
	...
	l, err := models.GetAllPagoRecibo(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "404", "Body": err.Error(), "Type": "error"}
		c.Data["system"] = err
...
func (c *PagoReciboController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.PagoRecibo{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdatePagoReciboById(&v); err == nil {
...
func (c *PagoReciboController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeletePagoRecibo(id); err == nil {
